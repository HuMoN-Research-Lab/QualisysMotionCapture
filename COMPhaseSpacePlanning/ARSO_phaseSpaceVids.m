...
for iter = 2%:3
    ...
    cd('/Users/MT/Documents/GitHub/MotionCapture_MATLABCode/COMPhaseSpacePlanning/sub01/c3d');
    ...
    [allSteps, step_fr_ft_XYZ]= ZeniStepFinder_ccpVid(c3d_fr_mar_dim, marNames);
    
    %% Plot
    
    
    
    c3d_fr_mar_dim(:,strcmp(marNames,'RBAK'),:) = nan(size(squeeze(c3d_fr_mar_dim(:,strcmp(marNames,'RBAK'),:))));
    
    c3d_fr_mar_dim(:,strcmp(marNames,'RTHI'),:) = nan(size(squeeze(c3d_fr_mar_dim(:,strcmp(marNames,'RTHI'),:))));
    c3d_fr_mar_dim(:,strcmp(marNames,'LTHI'),:) = nan(size(squeeze(c3d_fr_mar_dim(:,strcmp(marNames,'LTHI'),:))));
    
    c3d_fr_mar_dim(:,strcmp(marNames,'RFIN'),:) = nan(size(squeeze(c3d_fr_mar_dim(:,strcmp(marNames,'RFIN'),:))));
    c3d_fr_mar_dim(:,strcmp(marNames,'LFIN'),:) = nan(size(squeeze(c3d_fr_mar_dim(:,strcmp(marNames,'LFIN'),:))));
    c3d_fr_mar_dim(:,strcmp(marNames,'STER'),:) = nan(size(squeeze(c3d_fr_mar_dim(:,strcmp(marNames,'STER'),:))));
    ...
    c3d_fr_mar_dim(:,m1,:) = mean(c3d_fr_mar_dim(:,[m1 m2 m3 m4],:),2); %new head
    
    c3d_fr_mar_dim(:,m5,:) = mean(c3d_fr_mar_dim(:,[m15 m10],:),2); %new chest
    
    c3d_fr_mar_dim(:,m21,:) = mean(c3d_fr_mar_dim(:,[m19 m20 m21 m21 m21],:),2); %new pelvis
    ...
    while play
        ...
        linWidth = 4;
        plot3(c3d_fr_mar_dim(fr,head,1),c3d_fr_mar_dim(fr,head,2),c3d_fr_mar_dim(fr,head,3),'Color',c,'LineWidth',linWidth)
        hold on
        plot3(c3d_fr_mar_dim(fr,neck,1),c3d_fr_mar_dim(fr,neck,2),c3d_fr_mar_dim(fr,neck,3),'Color',c,'LineWidth',linWidth)
        
        plot3(c3d_fr_mar_dim(fr,spine,1),c3d_fr_mar_dim(fr,spine,2),c3d_fr_mar_dim(fr,spine,3),'Color',c,'LineWidth',linWidth)
        
        plot3(c3d_fr_mar_dim(fr,pelvis,1),c3d_fr_mar_dim(fr,pelvis,2),c3d_fr_mar_dim(fr,pelvis,3),'Color',c,'LineWidth',linWidth)
        
        plot3(c3d_fr_mar_dim(fr,rsho,1),c3d_fr_mar_dim(fr,rsho,2),c3d_fr_mar_dim(fr,rsho,3),'Color',c,'LineWidth',linWidth)
        plot3(c3d_fr_mar_dim(fr,rarm,1),c3d_fr_mar_dim(fr,rarm,2),c3d_fr_mar_dim(fr,rarm,3),'Color',c,'LineWidth',linWidth)
        plot3(c3d_fr_mar_dim(fr,rupleg,1),c3d_fr_mar_dim(fr,rupleg,2),c3d_fr_mar_dim(fr,rupleg,3),'Color',c,'LineWidth',linWidth)
        plot3(c3d_fr_mar_dim(fr,rlowleg,1),c3d_fr_mar_dim(fr,rlowleg,2),c3d_fr_mar_dim(fr,rlowleg,3),'Color',c,'LineWidth',linWidth)
        
        
        plot3(c3d_fr_mar_dim(fr,lsho,1),c3d_fr_mar_dim(fr,lsho,2),c3d_fr_mar_dim(fr,lsho,3),'Color',c,'LineWidth',linWidth)
        plot3(c3d_fr_mar_dim(fr,larm,1),c3d_fr_mar_dim(fr,larm,2),c3d_fr_mar_dim(fr,larm,3),'Color',c,'LineWidth',linWidth)
        plot3(c3d_fr_mar_dim(fr,lupleg,1),c3d_fr_mar_dim(fr,lupleg,2),c3d_fr_mar_dim(fr,lupleg,3),'Color',c,'LineWidth',linWidth)
        plot3(c3d_fr_mar_dim(fr,llowleg,1),c3d_fr_mar_dim(fr,llowleg,2),c3d_fr_mar_dim(fr,llowleg,3),'Color',c,'LineWidth',linWidth)
        
        
        
        plot3(c3d_fr_mar_dim(fr,incMar,1),c3d_fr_mar_dim(fr,incMar,2),c3d_fr_mar_dim(fr,incMar,3),'ko','MarkerFaceColor','k','MarkerSize',6);
        ...
        if fr == length(squeeze(c3d_fr_mar_dim(:,1,1)));
            break
        end
