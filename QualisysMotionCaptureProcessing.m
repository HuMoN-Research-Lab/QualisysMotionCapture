...
%kgW = lbs2kg(lbsWeight);

%Modify
cmHeight = ft2cm(totalHeight);
...
[bodySegLength] = bodySegLength(totalHeight);

%% bodySegMass function Calculation
% Function outputs mass for individual body segs
[bodySegWeight] = bodySegWeight(totalWeight);

%% segXYZPosition function 
% Function outputs XYZ position of x, y, z coordinates of body segs
[segXYZ] = segXYZ(marker_mar_dim_frame);

%% COM of seg
[comXYZ] = segWeight2bodyWeight(segXYZ,bodySegWeight); %markerLabels)
