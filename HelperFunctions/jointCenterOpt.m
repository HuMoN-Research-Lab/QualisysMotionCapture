...
for ii = 1:5:length(LHipCenter)
    ...
    if plot_skeleton == true
        %Plot Head
        plot3([HeadL(1,ii);HeadTop(1,ii);HeadR(1,ii);HeadFront(1,ii);SpineTop(1,ii);ChestCenter(1,ii)],...
            [HeadL(2,ii);HeadTop(2,ii);HeadR(2,ii);HeadFront(2,ii);SpineTop(2,ii);ChestCenter(2,ii)],...
            [HeadL(3,ii);HeadTop(3,ii);HeadR(3,ii);HeadFront(3,ii);SpineTop(3,ii);ChestCenter(3,ii)],'-k','MarkerSize',20)
