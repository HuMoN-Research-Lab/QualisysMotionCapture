function [LHipJointCenter,RHipJointCenter,RKneeJointCenter] = jointCenterOpt(segCenter_cal)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
if lookfor_LHipJointCenter == true
    ...
    [weights, LHipJointCenterError_final] = fmincon(LHipJointCenterError,initialWeightsGuess,A,b,Aeq,beq,lb,ub,[],opts);
...
if lookfor_RHipJointCenter == true
    ...
    %jointCenter difference = Optimized joint center loc in x,y,z
    [weights, RHipJointCenterError_final] = fmincon(RHipJointCenterError,initialWeightsGuess,A,b,Aeq,beq,lb,ub,[],opts);
...
if lookfor_LKneeJointCenter == true
    ...
    %jointCenter difference = Optimized joint center loc in x,y,z
    [weights, LKneeJointCenterError_final] = fmincon(LKneeJointCenterError,initialWeightsGuess,A,b,Aeq,beq,lb,ub,[],opts);
...
if lookfor_RKneeJointCenter == true
    ...
    %jointCenter difference = Optimized joint center loc in x,y,z
    [weights, RKneeJointCenterError_final] = fmincon(RKneeJointCenterError,initialWeightsGuess,A,b,Aeq,beq,lb,ub,[],opts);
...
if lookfor_LAnkleJointCenter == true
    ...
    %Optimizer for LKneeJointCenter weights
    %jointCenter difference = Optimized joint center loc in x,y,z
    [weights, LAnkleJointCenterError_final] = fmincon(LAnkleJointCenterError,initialWeightsGuess,A,b,Aeq,beq,lb,ub,[],opts);
...
if lookfor_RAnkleJointCenter == true
    ...
    %jointCenter difference = Optimized joint center loc in x,y,z
    [weights, RAnkleJointCenterError_final] = fmincon(RAnkleJointCenterError,initialWeightsGuess,A,b,Aeq,beq,lb,ub,[],opts);
...
for ii = 1:5:length(LHipCenter)
    ...
    if lookfor_LKneeJointCenter == true
        plot3(LKneeJointCenter(1,ii),LKneeJointCenter(2,ii),...
            LKneeJointCenter(3,ii),'r.','MarkerSize',12)
    end
    ...
    if lookfor_LAnkleJointCenter == true
        plot3(LAnkleJointCenter(1,ii),LAnkleJointCenter(2,ii),...
            LAnkleJointCenter(3,ii),'r.','MarkerSize',12)
    end
