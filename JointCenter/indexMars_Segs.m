...
skeleton.Spine =        squeeze(skeleton_mar_dim_frame(2,:,trial_start_end));
skeleton.Spine1 =       squeeze(skeleton_mar_dim_frame(3,:,trial_start_end));
skeleton.Spine2 =       squeeze(skeleton_mar_dim_frame(4,:,trial_start_end));
skeleton.Hips =         squeeze(skeleton_mar_dim_frame(1,:,trial_start_end));
...
skeleton.LUpperArm =    squeeze(skeleton_mar_dim_frame(6,:,trial_start_end));
skeleton.RUpperArm =    squeeze(skeleton_mar_dim_frame(10,:,trial_start_end));
skeleton.LForearm =     squeeze(skeleton_mar_dim_frame(7,:,trial_start_end));
skeleton.RForearm =     squeeze(skeleton_mar_dim_frame(11,:,trial_start_end));
skeleton.LHand =        squeeze(skeleton_mar_dim_frame(8,:,trial_start_end));
skeleton.RHand =        squeeze(skeleton_mar_dim_frame(12,:,trial_start_end));
skeleton.LThigh =       squeeze(skeleton_mar_dim_frame(15,:,trial_start_end));
skeleton.RThigh =       squeeze(skeleton_mar_dim_frame(19,:,trial_start_end));
skeleton.LLeg =         squeeze(skeleton_mar_dim_frame(16,:,trial_start_end));
skeleton.RLeg =         squeeze(skeleton_mar_dim_frame(20,:,trial_start_end));
skeleton.LFoot =        squeeze(skeleton_mar_dim_frame(17,:,trial_start_end));
skeleton.RFoot =        squeeze(skeleton_mar_dim_frame(21,:,trial_start_end));
