...
%% Head Seg
headCOM =        seg_prop_weight.headProp .* seg_center.headCenter_mar_dim_frame;
% headCOM =        (bodySegMass.headMass .* segCenter.headCenter_mar_dim_frame);

%% Shoulder Seg
LShoulderCOM =   seg_prop_weight.shoulderProp .* seg_center.LShoulderCenter_mar_dim_frame;
RShoulderCOM =   seg_prop_weight.shoulderProp .* seg_center.RShoulderCenter_mar_dim_frame;
