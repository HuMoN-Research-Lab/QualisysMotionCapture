...
head.marVelx =              (diff(head_marPosx(trial_start_end))*10^(-3))*frame_rate;
head_marVely_calc =         (diff(head_marPosy(trial_start_end))*10^(-3))*frame_rate;
...
head.marVelz =              (diff(head_marPosz(trial_start_end))*10^(-3))*frame_rate;
...
chest.marVelx =             (diff(chest_marPosx(trial_start_end))*10^(-3))*frame_rate;
chest_marVely_calc =        (diff(chest_marPosy(trial_start_end))*10^(-3))*frame_rate;
...
chest.marVelz =             (diff(chest_marPosz(trial_start_end))*10^(-3))*frame_rate;
...
hip.marVelx =             (diff(hip_marPosx(trial_start_end))*10^(-3))*frame_rate;
hip_marVely_calc =        (diff(hip_marPosy(trial_start_end))*10^(-3))*frame_rate;
...
hip.marVelz =             diff(hip_marPosz(trial_start_end))*10^(-3)*frame_rate;
...
LThigh.marVelx =             diff(LThigh_marPosx(trial_start_end))*10^(-3)*frame_rate;
LThigh_marVely_calc =        diff(LThigh_marPosy(trial_start_end))*10^(-3)*frame_rate;
...
LThigh.marVelz =             diff(LThigh_marPosz(trial_start_end))*10^(-3)*frame_rate;
...
RThigh.marVelx =             diff(RThigh_marPosx(trial_start_end))*10^(-3)*frame_rate;
RThigh_marVely_calc =        diff(RThigh_marPosy(trial_start_end))*10^(-3)*frame_rate;
...
RThigh.marVelz =             diff(RThigh_marPosz(trial_start_end))*10^(-3)*frame_rate;
...
LLeg.marVelx =             diff(LLeg_marPosx(trial_start_end))*10^(-3)*frame_rate;
LLeg_marVely_calc =        diff(LLeg_marPosy(trial_start_end))*10^(-3)*frame_rate;
...
LLeg.marVelz =             diff(LLeg_marPosz(trial_start_end))*10^(-3)*frame_rate;
...
RLeg.marVelx =             diff(RLeg_marPosx(trial_start_end))*10^(-3)*frame_rate;
RLeg_marVely_calc =        diff(RLeg_marPosy(trial_start_end))*10^(-3)*frame_rate;
...
RLeg.marVelz =             diff(RLeg_marPosz(trial_start_end))*10^(-3)*frame_rate;
...
LFoot.marVelx =             diff(LFoot_marPosx(trial_start_end))*10^(-3)*frame_rate;
LFoot_marVely_calc =        diff(LFoot_marPosy(trial_start_end))*10^(-3)*frame_rate;
...
LFoot.marVelz =             diff(LFoot_marPosz(trial_start_end))*10^(-3)*frame_rate;
...
RFoot.marVelx =             diff(RFoot_marPosx(trial_start_end))*10^(-3)*frame_rate;
RFoot_marVely_calc =        diff(RFoot_marPosy(trial_start_end))*10^(-3)*frame_rate;
...
RFoot.marVelz =             diff(RFoot_marPosz(trial_start_end))*10^(-3)*frame_rate;
