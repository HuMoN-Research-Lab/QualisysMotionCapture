function [data] = loc_missing_data(pre_filter_marker_mar_dim_frame,markerLabels,numMarkers)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Locate frames where Qualisys data missing
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
for ii = 1:length(nans_loc_cell) %ref to each col cell
    for jj = 1:3 %ref to each row cell
        if nans_loc_cell{jj,ii} > 0
            ...
            missingData = get_marker(pre_filter_marker_mar_dim_frame(:,:,:),markerLabels,'Jon_LeftLegCluster3');
            for kk = 1:3
